...
var UserController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        createdUser = _a.sent();
                        return [2 /*return*/, response.json(createdUser)];
                    case 2:
                        error_2 = _a.sent();
    ...
    UserController.prototype.updateOne = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, data, user, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    UserController.prototype.vouchers = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                }
                    ...
                    return [2 /*return*/, response.status(500).json({ code: 500, msg: error.message })];
                }
                return [2 /*return*/];
            });
        });
